export const loginBtn = document.querySelector(".header__btn--login");
export const loginWind = document.querySelector(".login");
export const loginBtnReg = document.querySelector(".login__btn");
export const createBtn = document.querySelector(".header__btn--create");
...
export const bmiInput = document.querySelector(".main__createVisit__bmi");
